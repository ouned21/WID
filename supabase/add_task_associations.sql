...
-- ─────────────────────────────────────────────────────────────────────────────
-- DONNÉES : Table des équipements pour l'onboarding
-- ─────────────────────────────────────────────────────────────────────────────
...
CREATE TABLE IF NOT EXISTS onboarding_equipment (
  ...
  name text NOT NULL,
  icon text NOT NULL,
  category text NOT NULL, -- 'cuisine', 'salle_de_bain', 'linge', 'sols', 'exterieur', 'vehicule', 'animaux'
  sort_order smallint DEFAULT 0,
  is_default boolean DEFAULT false -- coché par défaut dans l'onboarding
);

INSERT INTO onboarding_equipment (id, name, icon, category, sort_order, is_default) VALUES
-- Cuisine
